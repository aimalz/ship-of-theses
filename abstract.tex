Upcoming optical astronomical surveys, including the Legacy Survey of Space and Time (\lsst), will produce tremendous galaxy catalogs from purely photometric data.
