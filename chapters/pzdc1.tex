...
\chapter{ Evaluation of probabilistic photometric redshift estimation approaches for \textsc{LSST}\chaplabel{pzdc1}}
...
%	\includegraphics[width=0.49\textwidth]{figures/pzdc1/pz_12codes_713178_noseaborn_crop.jpg}\includegraphics[width=0.49\textwidth]{figures/pzdc1/pz_12codes_982747_noseaborn_crop.jpg}
	...
	\aim{I still need to polish this plot.}}
...
\begin{figure*}
	...
	\caption{The QQ plot (red) and PIT histogram (blue) of the \pzpdf\ codes (panels) along with the ideal QQ (black dashed diagonal) and ideal PIT (gray horizontal) curves.
...
\begin{figure*}
	...
	\aim{Polish this for readability.}}
