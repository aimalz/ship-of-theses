...
Though the outmoded practices should not be encouraged, those seeking a connection to previous comparison studies will find metrics of redshift point estimate reductions of \pzpdf s in \Sect{sec:pointmetrics} and metrics of a science-specific summary statistics heuristically derived from \pzpdf s in \Sect{sec:moments}.
...
\begin{figure*}
	...
	\caption{The QQ plot (green) and PIT histogram (yellow) of the \pzpdf\ codes (panels) along with the ideal QQ (purple dashed diagonal) and ideal PIT (purple dashed horizontal) curves.
...
\begin{figure*}
	\centering
	\includegraphics[width=0.74\textwidth]{figures/pzdc1/KSvsCvMvsAD_PIT.png}
	\caption{A visualization of the Kolmogorov-Smirnoff (KS, blue $\dot$), Cramer-von Mises (CvM, yellow $\times$), and Anderson-Darling (AD, green $+$) statistics for the PIT distributions.
...
\sectlabel{sec:stackedmetrics_results}
...
\begin{figure*}
	...
	\caption{A visualization of the Kolmogorov-Smirnoff (KS, blue $\dot$), Cramer-von Mises (CvM, yellow $\times$), and Anderson-Darling (AD, green $+$) statistics for the $\hat{N}(z)$ distributions.
...
\sectlabel{sec:pointmetrics_results}
