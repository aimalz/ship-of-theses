...
\aim{Probably won't have time to address this inconsistency}
This second variety of outliers is the only kind that can lead to multimodal \pzpdf s under the forward model.
\aim{Interpret this in terms of whether BPZ, etc. are yielding likelihoods and how it relates to the standard true vs. estimated redshift plot.}
...
\begin{figure}
	...
	\figlabel{fig:uniform-outliers-results}
\end{figure}
