...
\begin{enumerate}
	...
	\item Galaxy photometry $\data_{j}$ is drawn from the likelihoods $\pr{\data \gvn z_{j}}$.
\end{enumerate}
...
We compare the results of \Chippr\ to those of stacking and the histogram of \pzpdf\ maxima (modes) on mock data in the form of catalogs of emulated \pzpdf s generated via the forward model discussed above and presented in detail in \Sect{sec:data}.
