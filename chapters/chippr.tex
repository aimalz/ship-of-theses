...
The prevailing way to estimate \nz\ for a sample of $\ntot$ galaxies $i$ is to ``stack'' \pzpdf s according to \Eq{eqn:stack}.
...
Tests including all three effects at the tolerance levels of \lsst\ (see \tab{tab:lsstsrd}) are presented in \Sect{sec:results}, but \Fig{fig:mega_scatter} illustrates these three effects individually at twice the tolerance of \lsst\ for demonstrative purposes.
