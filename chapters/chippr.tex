...
\begin{figure*}
	\begin{center}
		\includegraphics[width=0.49\textwidth]{figures/chippr/wrong_scatter.png}
		\includegraphics[width=0.49\textwidth]{figures/chippr/wrong_log_estimators.png}
		\caption{
			\aim{Update this figure for 35 bins and consistent colors.}
		}
