...
\end{definition}
% \aim{Actually need to introduce conditional probability up here instead of later in \Sect{sec:pedanticres}.
% Not optional!}
...
\Pzpdf s are not delta functions because the data are inherently noisy and because our model for the relationship between photometry and redshift is imperfect, as was addressed in \Chap{intro} where Figure~\ref{intro:fig:fig:pedagogical_scatter} was introduced.
