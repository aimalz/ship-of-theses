...
\Pzpdf s have been produced by completed surveys \citep{Hildebrandt2012, sheldon_photometric_2012} and will be produced by ongoing and upcoming surveys \citep{LSSTScienceCollaboration2009, carrasco_kind_exhausting_2014, bonnett_redshift_2016, Masters2015}.  
\Pzpdf s are not without their own weaknesses, however, including the resources necessary to calculate and record them for large galaxy surveys \citep{carrasco_kind_sparse_2014} and the divergent results of each method used to derive them \citep{Hildebrandt2010, Dahlen2013, Sanchez2013, bonnett_redshift_2016, tanaka_photometric_2018}.  
