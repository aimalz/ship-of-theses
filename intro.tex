...
The projection of these effects into the space of true and estimated redshifts is discussed extensively in \Chap{chippr} and \Chap{pzdc1}.
...
An example of the impact of this selection bias in the context of \project{zCOSMOS} and \project{COSMOS} is shown in \Fig{fig:selection-bias}.
\aim{Cite COSMOS and zCOSMOS.}

\begin{figure*}
	\begin{center}
		\includegraphics[width=\textwidth]{figures/intro/big_corner_coarse.png}
		\caption{
...
However, it is more common at this point to calculate the mathematically invalid but conceptually simple \textit{stacked estimator} of the redshift distribution \citep[\Eq{eqn:stack}][]{Lima2008}.
%\begin{align}
%\eqlabel{eqn:stacked}
...
\Chippr\ is a probabilistic graphical model (PGM) that encapsulates the causal relationships between the redshift distribution, samples of individual galaxy redshifts, and .
