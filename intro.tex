...
\aim{Include a figure pointing out the three canonical \pz\ errors and explain their causes: intrinsic scatter due to broadband filters, perpendicular features due to features passing between bands, bias due to model misspecification, physical and algorithmic causes of catastrophic outliers.}
