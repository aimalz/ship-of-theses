...
Many techniques to obtain \pzpdf s have been proposed and tested in the literature.  
...
Some current work aims to vet \pzpdf\ generation methods \citep{Wittman2016}, one example of which comprises \Chap{pzdc1}.
...
{\item For \chap{qp}, I devised the idea for the project, conducted the investigation, and wrote the \texttt{qp} code under the supervision of Phil Marshall (SLAC), with contributions to the mock data production by Sam Schmidt (UC Davis), Melissa Graham (UW), Joe DeRose (Stanford), and Risa Wechsler (Stanford).}
